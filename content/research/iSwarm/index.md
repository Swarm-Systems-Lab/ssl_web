...
works: ["J26", "J25", "J24", "C42", "C41", "C39", "C38", "C36"]
# members: ["hector-garcia-de-marina", "jesus-bautista-villar", "A collaborator elsewhere"]
---
...
1. Develop a **general formulation** to characterize the controllability and stabilizability of emergent behaviors when imperfections are treated as control inputs.
2. Introduce **unconventional strategies**, such as mismatched Lyapunov functions, to engineer and shape emergent behaviors.
3. Construct **equivalence principles** between imperfections and inconsistent shared information to improve the effectiveness of swarm “collective awareness” and enable more robust fault-recovery algorithms.
4. Demonstrate the control of a state-of-the-art robot swarm under **non-laboratory conditions** by deliberately exploiting robot imperfections.
